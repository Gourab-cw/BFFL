    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? mainStore.theme.value.BottomNavColor
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Row(
                            ...
                            children: dailyScheduleController.dateList.map((m) {
                              DateTime d1 = m;
                              DateTime d0 =
                                  dailyScheduleController.selectedDate;
                              return getDayWidget(
                                d1,
                                DateFormat('yyyy-MM-dd').format(d0) ==
                                    DateFormat('yyyy-MM-dd').format(d1),
                              );
                            }).toList(),
                          ),
                        ),
                    ...
                    Row(
                      children: [
                        ...
                        TextHelper(
                          text: DateFormat(
                            'dd-MM-yyyy',
                          ).format(dailyScheduleController.selectedDate),
                            ...
                            children: [
                              TextHelper(
                                text: dailyScheduleController
                                    ...
                                    .values
                                    .map(
                                      (m) => m.where((w) => w.hasAttend).length,
                                    )
                                    .fold(0, (a, b) => a + b)
                                    .toString(),
                                fontsize: 15,
                              ...
                              Row(
                                ...
                                children: [
                                  Icon(
                                    MoonIcons
                                        .generic_check_alternative_24_regular,
                                    size: 20,
                                  ),
                                  TextHelper(
                                    text: 'Attended',
                    ...
                    Expanded(
                      child: Container(
                        decoration: BoxDecoration(
                          color: mainStore.theme.value.lowShadeColor.withAlpha(
                            100,
                          ),
                          border: Border.all(
                            color: mainStore.theme.value.mediumShadeColor,
                          ),
                          borderRadius: BorderRadius.circular(10),
                        ),
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: dailyScheduleController
                              .daysSessionList
                              .keys
                              .length,
                          itemBuilder: (ctx, index) {
                            final s = dailyScheduleController
                                .daysSessionList
                                .keys
                                .toList()[index];
                            return Container(
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                    ...
                                    itemCount: dailyScheduleController
                                        ...
                                        ?.length,
                                    itemBuilder: (ctx, index) {
                                      final session = dailyScheduleController
                                          .daysSessionList[s]?[index];
                                      if (session == null) {
