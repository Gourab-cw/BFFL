  ...
  void initState() {
    ...
    Future(() async {
      try {
        ...
        if (memberController.selectedUser == null && user.userType == UserType.member) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<MemberController>(
        ...
        builder: (memberController) {
          if (user == null) {
            return TextHelper(text: "No user found!", fontsize: 18, textalign: TextAlign.center);
          }
          return AppLoader(
                        ...
                        children: [
                          Flex(
                            ...
                            children: [
                              ...
                              SizedBox(
                                width: isExpanded ? MediaQuery.sizeOf(context).width - 151 : MediaQuery.sizeOf(context).width - 72,
                                child: Column(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TabBar(
                          ...
                          tabs: [
                            Tab(
                              child: Text('Details', textAlign: TextAlign.justify, style: TextStyle(fontSize: 12)),
                            ),
                            Tab(
                              child: Text('Booking History', textAlign: TextAlign.center, style: TextStyle(fontSize: 12)),
                            ),
                            Tab(
