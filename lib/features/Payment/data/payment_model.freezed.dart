...
@JsonKey(name: 'id', fromJson: parseStringV2) String get id;@JsonKey(name: 'branchId', fromJson: parseStringV2) String get branchId;@JsonKey(name: 'accountantId', fromJson: parseStringV2) String get accountantId;@JsonKey(name: 'companyId', fromJson: parseStringV2) String get companyId;@JsonKey(fromJson: timestampFromJson, toJson: timestampToJson) Timestamp get createdAt;@JsonKey(name: 'grossAmount', fromJson: parseDoubleV2) dynamic get grossAmount;@JsonKey(name: 'gstAmount', fromJson: parseDoubleV2) dynamic get gstAmount;@JsonKey(name: 'gstPer', fromJson: parseDoubleV2) dynamic get gstPer;@JsonKey(name: 'netAmount', fromJson: parseDoubleV2) dynamic get netAmount;@JsonKey(name: 'paidAmount', fromJson: parseDoubleV2) dynamic get paidAmount;@JsonKey(name: 'advanceAmount', fromJson: parseDoubleV2) dynamic get advanceAmount;@JsonKey(name: 'paymentModeId', fromJson: parseStringV2) String get paymentModeId;@JsonKey(name: 'paymentModeName', fromJson: parseStringV2) String get paymentModeName;@JsonKey(name: 'remarks', fromJson: parseStringV2) String get remarks;@JsonKey(name: 'serviceId', fromJson: parseStringV2) String get serviceId;@JsonKey(name: 'serviceName', fromJson: parseStringV2) String get serviceName;@JsonKey(name: 'subscriptionId', fromJson: parseStringV2) String get subscriptionId;@JsonKey(name: 'subscriptionName', fromJson: parseStringV2) String get subscriptionName;@JsonKey(name: 'txnValue', fromJson: parseStringV2) String get txnValue;@JsonKey(name: 'userId', fromJson: parseStringV2) String get userId;@JsonKey(name: 'userName', fromJson: parseStringV2) String get userName;@JsonKey(name: 'voucherAmount', fromJson: parseDoubleV2) double get voucherAmount;@JsonKey(name: 'voucherId', fromJson: parseStringV2) String get voucherId;@JsonKey(name: 'voucherNumber', fromJson: parseStringV2) String get voucherNumber;@JsonKey(name: 'subscriptions', fromJson: _subscriptionFromJson, toJson: _subscriptionToJson) List<UserSubscription>? get subscriptions; bool get isActive;
...
@useResult
$Res call({
@JsonKey(name: 'id', fromJson: parseStringV2) String id,@JsonKey(name: 'branchId', fromJson: parseStringV2) String branchId,@JsonKey(name: 'accountantId', fromJson: parseStringV2) String accountantId,@JsonKey(name: 'companyId', fromJson: parseStringV2) String companyId,@JsonKey(fromJson: timestampFromJson, toJson: timestampToJson) Timestamp createdAt,@JsonKey(name: 'grossAmount', fromJson: parseDoubleV2) dynamic grossAmount,@JsonKey(name: 'gstAmount', fromJson: parseDoubleV2) dynamic gstAmount,@JsonKey(name: 'gstPer', fromJson: parseDoubleV2) dynamic gstPer,@JsonKey(name: 'netAmount', fromJson: parseDoubleV2) dynamic netAmount,@JsonKey(name: 'paidAmount', fromJson: parseDoubleV2) dynamic paidAmount,@JsonKey(name: 'advanceAmount', fromJson: parseDoubleV2) dynamic advanceAmount,@JsonKey(name: 'paymentModeId', fromJson: parseStringV2) String paymentModeId,@JsonKey(name: 'paymentModeName', fromJson: parseStringV2) String paymentModeName,@JsonKey(name: 'remarks', fromJson: parseStringV2) String remarks,@JsonKey(name: 'serviceId', fromJson: parseStringV2) String serviceId,@JsonKey(name: 'serviceName', fromJson: parseStringV2) String serviceName,@JsonKey(name: 'subscriptionId', fromJson: parseStringV2) String subscriptionId,@JsonKey(name: 'subscriptionName', fromJson: parseStringV2) String subscriptionName,@JsonKey(name: 'txnValue', fromJson: parseStringV2) String txnValue,@JsonKey(name: 'userId', fromJson: parseStringV2) String userId,@JsonKey(name: 'userName', fromJson: parseStringV2) String userName,@JsonKey(name: 'voucherAmount', fromJson: parseDoubleV2) double voucherAmount,@JsonKey(name: 'voucherId', fromJson: parseStringV2) String voucherId,@JsonKey(name: 'voucherNumber', fromJson: parseStringV2) String voucherNumber,@JsonKey(name: 'subscriptions', fromJson: _subscriptionFromJson, toJson: _subscriptionToJson) List<UserSubscription>? subscriptions, bool isActive
});
...
as dynamic,advanceAmount: freezed == advanceAmount ? _self.advanceAmount : advanceAmount // ignore: cast_nullable_to_non_nullable
...
as List<UserSubscription>?,isActive: null == isActive ? _self.isActive : isActive // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id', fromJson: parseStringV2)  String id, @JsonKey(name: 'branchId', fromJson: parseStringV2)  String branchId, @JsonKey(name: 'accountantId', fromJson: parseStringV2)  String accountantId, @JsonKey(name: 'companyId', fromJson: parseStringV2)  String companyId, @JsonKey(fromJson: timestampFromJson, toJson: timestampToJson)  Timestamp createdAt, @JsonKey(name: 'grossAmount', fromJson: parseDoubleV2)  dynamic grossAmount, @JsonKey(name: 'gstAmount', fromJson: parseDoubleV2)  dynamic gstAmount, @JsonKey(name: 'gstPer', fromJson: parseDoubleV2)  dynamic gstPer, @JsonKey(name: 'netAmount', fromJson: parseDoubleV2)  dynamic netAmount, @JsonKey(name: 'paidAmount', fromJson: parseDoubleV2)  dynamic paidAmount, @JsonKey(name: 'advanceAmount', fromJson: parseDoubleV2)  dynamic advanceAmount, @JsonKey(name: 'paymentModeId', fromJson: parseStringV2)  String paymentModeId, @JsonKey(name: 'paymentModeName', fromJson: parseStringV2)  String paymentModeName, @JsonKey(name: 'remarks', fromJson: parseStringV2)  String remarks, @JsonKey(name: 'serviceId', fromJson: parseStringV2)  String serviceId, @JsonKey(name: 'serviceName', fromJson: parseStringV2)  String serviceName, @JsonKey(name: 'subscriptionId', fromJson: parseStringV2)  String subscriptionId, @JsonKey(name: 'subscriptionName', fromJson: parseStringV2)  String subscriptionName, @JsonKey(name: 'txnValue', fromJson: parseStringV2)  String txnValue, @JsonKey(name: 'userId', fromJson: parseStringV2)  String userId, @JsonKey(name: 'userName', fromJson: parseStringV2)  String userName, @JsonKey(name: 'voucherAmount', fromJson: parseDoubleV2)  double voucherAmount, @JsonKey(name: 'voucherId', fromJson: parseStringV2)  String voucherId, @JsonKey(name: 'voucherNumber', fromJson: parseStringV2)  String voucherNumber, @JsonKey(name: 'subscriptions', fromJson: _subscriptionFromJson, toJson: _subscriptionToJson)  List<UserSubscription>? subscriptions,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentModel() when $default != null:
return $default(_that.id,_that.branchId,_that.accountantId,_that.companyId,_that.createdAt,_that.grossAmount,_that.gstAmount,_that.gstPer,_that.netAmount,_that.paidAmount,_that.advanceAmount,_that.paymentModeId,_that.paymentModeName,_that.remarks,_that.serviceId,_that.serviceName,_that.subscriptionId,_that.subscriptionName,_that.txnValue,_that.userId,_that.userName,_that.voucherAmount,_that.voucherId,_that.voucherNumber,_that.subscriptions,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id', fromJson: parseStringV2)  String id, @JsonKey(name: 'branchId', fromJson: parseStringV2)  String branchId, @JsonKey(name: 'accountantId', fromJson: parseStringV2)  String accountantId, @JsonKey(name: 'companyId', fromJson: parseStringV2)  String companyId, @JsonKey(fromJson: timestampFromJson, toJson: timestampToJson)  Timestamp createdAt, @JsonKey(name: 'grossAmount', fromJson: parseDoubleV2)  dynamic grossAmount, @JsonKey(name: 'gstAmount', fromJson: parseDoubleV2)  dynamic gstAmount, @JsonKey(name: 'gstPer', fromJson: parseDoubleV2)  dynamic gstPer, @JsonKey(name: 'netAmount', fromJson: parseDoubleV2)  dynamic netAmount, @JsonKey(name: 'paidAmount', fromJson: parseDoubleV2)  dynamic paidAmount, @JsonKey(name: 'advanceAmount', fromJson: parseDoubleV2)  dynamic advanceAmount, @JsonKey(name: 'paymentModeId', fromJson: parseStringV2)  String paymentModeId, @JsonKey(name: 'paymentModeName', fromJson: parseStringV2)  String paymentModeName, @JsonKey(name: 'remarks', fromJson: parseStringV2)  String remarks, @JsonKey(name: 'serviceId', fromJson: parseStringV2)  String serviceId, @JsonKey(name: 'serviceName', fromJson: parseStringV2)  String serviceName, @JsonKey(name: 'subscriptionId', fromJson: parseStringV2)  String subscriptionId, @JsonKey(name: 'subscriptionName', fromJson: parseStringV2)  String subscriptionName, @JsonKey(name: 'txnValue', fromJson: parseStringV2)  String txnValue, @JsonKey(name: 'userId', fromJson: parseStringV2)  String userId, @JsonKey(name: 'userName', fromJson: parseStringV2)  String userName, @JsonKey(name: 'voucherAmount', fromJson: parseDoubleV2)  double voucherAmount, @JsonKey(name: 'voucherId', fromJson: parseStringV2)  String voucherId, @JsonKey(name: 'voucherNumber', fromJson: parseStringV2)  String voucherNumber, @JsonKey(name: 'subscriptions', fromJson: _subscriptionFromJson, toJson: _subscriptionToJson)  List<UserSubscription>? subscriptions,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _PaymentModel():
return $default(_that.id,_that.branchId,_that.accountantId,_that.companyId,_that.createdAt,_that.grossAmount,_that.gstAmount,_that.gstPer,_that.netAmount,_that.paidAmount,_that.advanceAmount,_that.paymentModeId,_that.paymentModeName,_that.remarks,_that.serviceId,_that.serviceName,_that.subscriptionId,_that.subscriptionName,_that.txnValue,_that.userId,_that.userName,_that.voucherAmount,_that.voucherId,_that.voucherNumber,_that.subscriptions,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
class _PaymentModel implements PaymentModel {
  const _PaymentModel({@JsonKey(name: 'id', fromJson: parseStringV2) required this.id, @JsonKey(name: 'branchId', fromJson: parseStringV2) required this.branchId, @JsonKey(name: 'accountantId', fromJson: parseStringV2) required this.accountantId, @JsonKey(name: 'companyId', fromJson: parseStringV2) required this.companyId, @JsonKey(fromJson: timestampFromJson, toJson: timestampToJson) required this.createdAt, @JsonKey(name: 'grossAmount', fromJson: parseDoubleV2) this.grossAmount, @JsonKey(name: 'gstAmount', fromJson: parseDoubleV2) this.gstAmount, @JsonKey(name: 'gstPer', fromJson: parseDoubleV2) this.gstPer, @JsonKey(name: 'netAmount', fromJson: parseDoubleV2) this.netAmount, @JsonKey(name: 'paidAmount', fromJson: parseDoubleV2) this.paidAmount, @JsonKey(name: 'advanceAmount', fromJson: parseDoubleV2) this.advanceAmount, @JsonKey(name: 'paymentModeId', fromJson: parseStringV2) required this.paymentModeId, @JsonKey(name: 'paymentModeName', fromJson: parseStringV2) required this.paymentModeName, @JsonKey(name: 'remarks', fromJson: parseStringV2) required this.remarks, @JsonKey(name: 'serviceId', fromJson: parseStringV2) required this.serviceId, @JsonKey(name: 'serviceName', fromJson: parseStringV2) required this.serviceName, @JsonKey(name: 'subscriptionId', fromJson: parseStringV2) required this.subscriptionId, @JsonKey(name: 'subscriptionName', fromJson: parseStringV2) required this.subscriptionName, @JsonKey(name: 'txnValue', fromJson: parseStringV2) required this.txnValue, @JsonKey(name: 'userId', fromJson: parseStringV2) required this.userId, @JsonKey(name: 'userName', fromJson: parseStringV2) required this.userName, @JsonKey(name: 'voucherAmount', fromJson: parseDoubleV2) required this.voucherAmount, @JsonKey(name: 'voucherId', fromJson: parseStringV2) required this.voucherId, @JsonKey(name: 'voucherNumber', fromJson: parseStringV2) required this.voucherNumber, @JsonKey(name: 'subscriptions', fromJson: _subscriptionFromJson, toJson: _subscriptionToJson) final  List<UserSubscription>? subscriptions, this.isActive = true}): _subscriptions = subscriptions;
...
@override@JsonKey(name: 'advanceAmount', fromJson: parseDoubleV2) final  dynamic advanceAmount;
...
@override@JsonKey(name: 'subscriptions', fromJson: _subscriptionFromJson, toJson: _subscriptionToJson) List<UserSubscription>? get subscriptions {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PaymentModel&&(identical(other.id, id) || other.id == id)&&(identical(other.branchId, branchId) || other.branchId == branchId)&&(identical(other.accountantId, accountantId) || other.accountantId == accountantId)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.grossAmount, grossAmount)&&const DeepCollectionEquality().equals(other.gstAmount, gstAmount)&&const DeepCollectionEquality().equals(other.gstPer, gstPer)&&const DeepCollectionEquality().equals(other.netAmount, netAmount)&&const DeepCollectionEquality().equals(other.paidAmount, paidAmount)&&const DeepCollectionEquality().equals(other.advanceAmount, advanceAmount)&&(identical(other.paymentModeId, paymentModeId) || other.paymentModeId == paymentModeId)&&(identical(other.paymentModeName, paymentModeName) || other.paymentModeName == paymentModeName)&&(identical(other.remarks, remarks) || other.remarks == remarks)&&(identical(other.serviceId, serviceId) || other.serviceId == serviceId)&&(identical(other.serviceName, serviceName) || other.serviceName == serviceName)&&(identical(other.subscriptionId, subscriptionId) || other.subscriptionId == subscriptionId)&&(identical(other.subscriptionName, subscriptionName) || other.subscriptionName == subscriptionName)&&(identical(other.txnValue, txnValue) || other.txnValue == txnValue)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.userName, userName) || other.userName == userName)&&(identical(other.voucherAmount, voucherAmount) || other.voucherAmount == voucherAmount)&&(identical(other.voucherId, voucherId) || other.voucherId == voucherId)&&(identical(other.voucherNumber, voucherNumber) || other.voucherNumber == voucherNumber)&&const DeepCollectionEquality().equals(other._subscriptions, _subscriptions)&&(identical(other.isActive, isActive) || other.isActive == isActive));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,branchId,accountantId,companyId,createdAt,const DeepCollectionEquality().hash(grossAmount),const DeepCollectionEquality().hash(gstAmount),const DeepCollectionEquality().hash(gstPer),const DeepCollectionEquality().hash(netAmount),const DeepCollectionEquality().hash(paidAmount),const DeepCollectionEquality().hash(advanceAmount),paymentModeId,paymentModeName,remarks,serviceId,serviceName,subscriptionId,subscriptionName,txnValue,userId,userName,voucherAmount,voucherId,voucherNumber,const DeepCollectionEquality().hash(_subscriptions),isActive]);
