...
class _CalenderReportState extends State<CalenderReport> {
  ...
  final CalenderReportController calenderReportController =
      Get.find<CalenderReportController>();
    ...
    try {
      ...
      if (calenderReportController.selectedBranch == null) {
        ...
        if (branchController.list.isNotEmpty) {
          calenderReportController.selectedBranch = branchController.list[0]
              .toJson();
        }
      }
                                ...
                                Expanded(
                                  child: DropDownHelperG(
                                    ...
                                    onValueChange: (v) async {
                                      calenderReportController.selectedBranch =
                                          v;
                                      await loadData();
                  ...
                  CalendarDatePicker2(
                    config: CalendarDatePicker2Config(
                      ...
                      dayBuilder:
                          ({
                            required DateTime
                            date, // Changed from dynamic dateToBuild
                            ...
                            final tc = calenderReportController.totalCount(
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: TextHelper(
                          text:
                              "Details of ${DateFormat('dd-MM-yyyy').format(calenderReportController.selectedDate)}",
                          fontweight: FontWeight.w600,
                        ),
                      ),
                    ],
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              TextHelper(
                                text: "${m.booked} / ${m.maxBookingSlot}",
                                fontsize: 13,
                                fontweight: FontWeight.w600,
                                isWrap: true,
                              ),
