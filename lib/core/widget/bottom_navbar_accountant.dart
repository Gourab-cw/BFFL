...
class BottomNavbarAccountant extends StatefulWidget {
  const BottomNavbarAccountant({super.key});

  @override
  State<BottomNavbarAccountant> createState() => _BottomNavbarAccountantState();
}

class _BottomNavbarAccountantState extends State<BottomNavbarAccountant> {
